...
const Waypoint path[NUM_WAYPOINTS] = {
    {0.0f, 0.0f}, {20.0f, 5.0f}, {40.0f, 25.0f}, {60.0f, 20.0f}, {80.0f, 0.0f}};
...
void runPurePursuitStep() {
  ...
  float distToGoal =
      getDistance(robotX, robotY, path[NUM_WAYPOINTS - 1].x, path[NUM_WAYPOINTS - 1].y);
  if (distToGoal < 4.0f) {
  ...
  if (printPlotter) {
    Serial.print(F("RobotX:"));
    Serial.print(robotX, 2);
    Serial.print(F(",RobotY:"));
    Serial.print(robotY, 2);
    Serial.print(F(",TargetX:"));
    Serial.print(targetX, 2);
    Serial.print(F(",TargetY:"));
    Serial.print(targetY, 2);
    Serial.print(F(",Curvature:"));
    Serial.print(gamma * 10.0f);  // Scaled for plotting visibility
    Serial.print(F(",Heading:"));
    Serial.println(robotTheta * 180.0f / PI, 1);
  }
}
