 ...
 *    via the Inter-Integrated Circuit (I2C) serial bus, which requires only **2 wires (SDA and SCL)**.
 *    The chip receives 8-bit digital serial packets and translates them to parallel lines to drive
 *    the LCD.
