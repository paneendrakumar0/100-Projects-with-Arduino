 ...
 *    It contains two piezoelectric transducers: one transmitter (speaker) and one receiver
 * (microphone).
 ...
 * 3. The time the Echo pin remains HIGH equals the total travel time (round trip) of the sound
 * wave.
 * 4. Physics Math:
