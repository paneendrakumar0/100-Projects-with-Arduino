 ...
 *    "Bouncy Press" (rapidly toggling the pin to simulate the physical contact bounces of a
 * switch).
...
void printStats() {
  ...
  Serial.print(F(" Raw ISR Triggers (Bouncy): "));
  Serial.println(raw);
  Serial.print(F(" Valid Debounced Counts:    "));
  Serial.println(debounced);
  Serial.print(F(" Bounces Filtered Out:      "));
  Serial.println(raw - debounced);
  Serial.println(F("---------------------------------------------------"));
}
