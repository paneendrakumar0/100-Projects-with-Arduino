 ...
 *    - Capacitive Humidity Sensor: Has two electrodes with a moisture-holding substrate between
 * them. As water vapor is absorbed by the substrate, its dielectric constant changes, altering the
 ...
 *      increases.
 * 2. Built-in 8-bit Microcontroller: The DHT11 has a tiny internal chip that measures these analog
 * values, converts them, and transmits them to the Arduino using a custom **40-bit Single-Bus
 * Serial Protocol**.
