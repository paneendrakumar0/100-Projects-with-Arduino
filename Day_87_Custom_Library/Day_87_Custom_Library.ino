 ...
 *   - Higher alpha values (e.g., 0.8) track the signal rapidly with minimal lag, but pass more
 * noise.
 *
 * WIRING:
...
void printMenu() {
  ...
  Serial.print(F(" Active Alpha Coefficient: "));
  Serial.println(myFilter.getAlpha(), 2);
