...
void setup() {
  ...
  Serial.print(F("[IK] L1 = ")); Serial.print(L1); Serial.print(F(" mm, L2 = ")); Serial.println(L2);
  Serial.print(F("[IK] Workspace radius: ")); Serial.print(fabsf(L1 - L2));
  Serial.print(F(" to ")); Serial.print(L1 + L2); Serial.println(F(" mm"));
}
...
void loop() {
  ...
  if (curBtn == LOW && lastBtn == HIGH) {
    elbowUp = !elbowUp;
    Serial.print(F("[IK] Elbow config: ")); Serial.println(elbowUp ? F("UP") : F("DOWN"));
    delay(50); // Debounce
  }
  lastBtn = curBtn;
  ...
  if (millis() - lastPrint >= 200) {
    ...
    Serial.print(targetX, 0); Serial.print(F(","));
    Serial.print(targetY, 0); Serial.print(F(") | Theta1="));
    Serial.print(ik.theta1_deg, 1); Serial.print(F("° Theta2="));
    Serial.print(ik.theta2_deg, 1); Serial.print(F("°"));
