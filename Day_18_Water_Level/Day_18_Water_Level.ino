 ...
 *    power the sensor from a digital I/O pin (Pin 7). We pull this pin HIGH for 10ms to take a
 * reading, then pull it LOW. This cuts power for 99% of the time, completely preventing
 * electrochemical electrolysis corrosion of the sensor traces.
