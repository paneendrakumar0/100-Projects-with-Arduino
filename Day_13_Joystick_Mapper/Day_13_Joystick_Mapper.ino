 ...
 * 2. Deadband Filter: A center "dead zone" is defined. Jitter around the center rest point is ignored,
 *    ensuring stable, zeroed readings when the joystick is untouched.
 * 3. Range Mapping: Translates raw 10-bit ADC signals into a Cartesian coordinate system
 *    spanning from -100 (full left/down) to +100 (full right/up) - ideal for motor drive controllers.
