...
const String scrollMessage = "Welcome to Day 23 of the 100-Day Arduino Masterclass! Learn mechatronics step by step.   ";
...
const unsigned long scrollDelay = 350; // Scroll speed in ms per character (350ms is standard readability)
