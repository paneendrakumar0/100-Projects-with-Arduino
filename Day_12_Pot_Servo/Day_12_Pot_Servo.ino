 ...
 *    (electrical noise) from the potentiometer. This prevents the servo motor from constantly
 * humming, grinding, vibrating, and drawing excessive current when the dial is held still.
 *
 * THEORY OF OPERATION:
 ...
 *      the servo receives continuous micro-step adjustments, causing it to buzz, overheat, and
 * fail.
 ...
 *    If the change is less than 4 units (approx 0.4% change), we discard it as noise and make no
 * adjustments.
 *
 * WIRING:
