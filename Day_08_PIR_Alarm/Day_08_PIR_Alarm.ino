 ...
 *    a human or animal) walks past, it crosses one half before the other, creating a differential voltage.
...
const int CALIBRATION_TIME = 15; // PIR warm-up time in seconds (standard is 30-60s; 15s for quick demo)
