 ...
 *   1. Bit-Reversal Permutation: Reorders the input data index bits to align values for butterfly math.
 ...
 * in the Serial Monitor, providing a dynamic frequency visualizer without external display overhead.
 * 
 * WIRING:
